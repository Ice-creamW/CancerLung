...
st.markdown("""
### 💡 คำอธิบายเกณฑ์คะแนน (1-9)
สำหรับการกรอกข้อมูลอาการและพฤติกรรม โปรดใช้เกณฑ์ดังนี้:
* **ระดับ 1:** น้อยที่สุด / ไม่เคยเลย / ปกติมาก
* **ระดับ 5:** ปานกลาง / เริ่มมีอาการชัดเจน
* **ระดับ 8-9:** มากที่สุด / บ่อยมาก / รุนแรงมาก
---
""")
...
if df is not None:
    ...
    if st.button("Prediction"):
        ...
        st.info("💡 หมายเหตุ: ผลการทำนายนี้เป็นเพียงการวิเคราะห์เบื้องต้นจากข้อมูล ไม่สามารถใช้แทนการวินิจฉัยโดยแพทย์ได้")
